%% QuestionD.m
%   Demonstrate FDTD transmission line assuming lossless tx-line
%       with R = 100 at x=0 and R = 50 at x=1
%
...
while stop == 0 
    ...
    Vt_near = Gaussian(1,3e-9,0.5e-9,tv)
    Vt_far = Gaussian(1,3e-9,0.5e-9,tv)
