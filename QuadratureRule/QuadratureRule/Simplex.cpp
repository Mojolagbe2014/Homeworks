...
void Simplex::comp_next ( int n, int k, int a[], bool &more, int &h, int &t )
...
void Simplex::gm_general_rule_set ( int rule, int m, int n, double t[], double w[],
                          double x[] )
...
int Simplex::gm_rule_size ( int rule, int m )
...
void Simplex::gm_unit_rule_set ( int rule, int m, int n, double w[], double x[] )
...
int Simplex::i4_choose ( int n, int k )
...
int Simplex::i4_max ( int i1, int i2 )
...
int Simplex::i4_min ( int i1, int i2 )
...
int Simplex::i4_power ( int i, int j )
...
double * Simplex::monomial_value ( int m, int n, int e[], double x[] )
...
double Simplex::r8_factorial ( int n )
...
double Simplex::r8ge_det ( int n, double a_lu[], int pivot[] )
...
int Simplex::r8ge_fa ( int n, double a[], int pivot[] )
...
double Simplex::r8vec_dot_product ( int n, double a1[], double a2[] )
...
double * Simplex::r8vec_uniform_01_new ( int n, int &seed )
...
double Simplex::simplex_general_volume ( int m, double t[] )
...
double Simplex::simplex_unit_monomial_integral ( int m, int expon[] )
...
double Simplex::simplex_unit_monomial_quadrature ( int m, int expon[], int n, double x[],
                                         double w[] )
...
double * Simplex::simplex_unit_sample ( int m, int n, int &seed )
...
void Simplex::simplex_unit_to_general ( int m, int n, double t[], double ref[],
                              double phy[] )
...
double Simplex::simplex_unit_volume ( int m )
