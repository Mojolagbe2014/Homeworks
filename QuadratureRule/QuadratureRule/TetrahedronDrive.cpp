...
//
{
    ...
    timestamp ( );
    cout << "\n";
    cout << "TETRAHEDRON_ARBQ_RULE_PRB\n";
    cout << "  C++ version\n";
    cout << "  Test the TETRAHEDRON_ARBQ_RULE library.\n";
...
//
{
    ...
    cout << "\n";
    cout << "TEST01\n";
    cout << "  Quadrature rule for a tetrahedron.\n";
...
//
{
    ...
    cout << "\n";
    cout << "TEST02\n";
    cout << "  Get a quadrature rule for the tetrahedron.\n";
